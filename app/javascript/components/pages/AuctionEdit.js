        ...
        <body className="body">
          ...
          <Form>
            ...
            <FormGroup>
              ...
              <Input
                ...
                type="datetime-local"
                onChange={this.handleChange}
                value={moment(this.state.updateAuction.start_date_time).format(
                  "YYYY-MM-DDTHH:mm:ss"
                )}
                className="textfield"
              />
            ...
            <FormGroup>
              ...
              <Input
                ...
                type="datetime-local"
                onChange={this.handleChange}
                value={moment(this.state.updateAuction.end_date_time).format(
                  "YYYY-MM-DDTHH:mm:ss"
                )}
                className="textfield"
              />
          ...
          <div className="container">
            ...
            {this.state.submitted && (
              <Redirect to={`/auction_show_route/${auction.id}`} />
            )}
          </div>
        </body>
      </>
